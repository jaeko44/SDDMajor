...
#Region " Dark Colors"
    ...
    Private _HeaderColor As Color = Color.FromArgb(171, 171, 172)
    Private _BaseColor As Color = Color.FromArgb(196, 199, 200)
    Private _BorderColor As Color = Color.FromArgb(53, 58, 60)
    Private TextColor As Color = Color.FromArgb(45, 47, 49)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Dim Base As New Rectangle(0, 0, W, H), Header As New Rectangle(0, 0, W, 35)
        ...
        With G
            ...
            '-- Logo
            .FillRectangle(New SolidBrush(Color.FromArgb(243, 243, 243)), New Rectangle(8, 16, 4, 12))
            .FillRectangle(New SolidBrush(_FlatColor), 16, 16, 4, 12)
            .DrawString(Text, Font, New SolidBrush(TextColor), New Rectangle(20, 13, W, H), NearSF)
...
#End Region
    ...
    End Sub
End Class
Class FlatHelp : Inherits Control
...
#End Region
    ...
    Sub New()
        SetStyle(ControlStyles.AllPaintingInWmPaint Or ControlStyles.UserPaint Or _
                 ControlStyles.ResizeRedraw Or ControlStyles.OptimizedDoubleBuffer, True)
        DoubleBuffered = True
        BackColor = Color.FromArgb(196, 199, 200)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .FillPath(New SolidBrush(Color.FromArgb(196, 199, 200)), GP3)
...
#Region " Colors"
    ...
    Private BGColor As Color = Color.FromArgb(196, 199, 200)
    Private _BaseColor As Color = Color.FromArgb(45, 47, 49)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- Text
            .DrawString(Text, Font, Brushes.Black, New Rectangle(10, 4, W, H), NearSF)
